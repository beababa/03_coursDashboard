...
#  275 985 au lieu de 275 234, ce sont les parcelles sur les frontières.
```
...
layoutLayer(title = paste0(
                   ...
                   length(inter$id), " _  aire moyenne : ", 
                   round(mean(st_area(parcelleSplit))/10000,0)
                   )
            )
dev.off()
...
### ... Et si on prenait plutôt les centroïdes
