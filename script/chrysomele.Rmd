...
st_write(grosseAnomalie, "../dataS/chrysomele.gpkg", "anomalie", delete_layer = TRUE, quiet = TRUE)
st_write(petiteAnomalie, "../dataS/chrysomele.gpkg", "anomalie", delete_layer = TRUE, quiet = TRUE)
