...
Contrôle validité des géométries 

On écarte les GEOMETRY COLLECTION et tous les trops petits polygones
...
# petits polygones
library(units)
inter$aire <- drop_units( st_area(inter$geom))
summary(inter$aire)
# on supprime toutes les aires < 500
inter <- inter [inter$aire > 500,]
# 274 083 obs
...
summary(zone1)
# on met la barre à 10 000
zone1 <- zone1 [zone1$aire > 10000,]
