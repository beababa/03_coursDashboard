...
En fait l'exploration statistique passe par un histogramme qui permet de définir les seuils
que l'on va cartographier.

```{r}
hist(data$Men_pauv)
# Définition de 3 paliers
paliers <- c(0,50,200,300)
mf_map(data, type ="choro", var = "Men_pauv", breaks = paliers, pal = "Burg", border = "antiquewhite1", leg_title = "Nb de ménages pauvres")
