...
# Préparation des données pour l'examen


## Le fichier spatial

Les données INSEE sont très lourdes (223 M°)
Dans le cadre de l'examen sont mises à disposition les données concernant uniquement
l'Ile de France.
...
```{r}
for (i in 1:length(ref$lien.ok)-1){
  download.file(ref$lien.ok [i], paste0("DST/",ref$Prénom [i], ".Rmd"))
}
